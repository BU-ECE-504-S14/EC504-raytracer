...
public class Simple_RayTracer {
	 ...
	 */
	public Simple_RayTracer(Scene scene, Dimension imageSize, int antialiasing, int shadow) {
		super();
		this.scene = scene;
	 ...
	 * @param currentLevel Current level of recursion (0 at invocation) (not used yet)
	 * @param viewerPosition Position of the observer.  In the first invocation, it is the origin (not used yet)
