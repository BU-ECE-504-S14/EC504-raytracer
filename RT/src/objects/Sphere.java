...
public class Sphere extends AbstractSceneObject
{
	...
	public Intersection intersectsRay(Ray ray)
	{
		...
		double b = 2 * ray.direction.dot(aux); // parameterized ray line of distance
												// center of sphere to beginning of ray
	...
	{
		return "Sphere name= " + name + ", radius=" + radius + ", position=" + position + ")" + material.toString();
	}
}
